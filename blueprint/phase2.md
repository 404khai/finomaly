...
Action Items:
Write src/data_engineering/build_graph.py:
...
Write src/models/train_gnn.py to train the model and save the learned Node Embeddings (the output of the second-to-last layer) as a PyTorch tensor.
